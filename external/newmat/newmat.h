...
public:
   ...
   inline Real* operator[](int m) { return store+m*ncols; }
   inline const Real* operator[](int m) const { return store+m*ncols; }
#endif
...
public:
   ...
   Real element(int, int) const;                // access element
#ifdef SETUP_C_SUBSCRIPTS
   inline Real* operator[](int m) { return store+(m*(m+1))/2; }
   inline const Real* operator[](int m) const { return store+(m*(m+1))/2; }
#endif
   MatrixType Type() const;
...
public:
   ...
   Real element(int, int) const;                // access element
#ifdef SETUP_C_SUBSCRIPTS
   inline Real* operator[](int m) { return store+m*ncols-(m*(m+1))/2; }
   inline const Real* operator[](int m) const { return store+m*ncols-(m*(m+1))/2; }
#endif
   MatrixType Type() const;
...
#ifdef SETUP_C_SUBSCRIPTS
   inline Real& operator[](int m) { return store[m]; }
   inline const Real& operator[](int m) const { return store[m]; }
#endif
   MatrixType Type() const;
...
public:
   ...
   Real element(int, int) const;                // access element
#ifdef SETUP_C_SUBSCRIPTS
   inline Real* operator[](int m) { return store+(upper+lower)*m+lower; }
   inline const Real* operator[](int m) const { return store+(upper+lower)*m+lower; }
#endif
...
#ifdef SETUP_C_SUBSCRIPTS
   inline Real* operator[](int m) { return store+upper*m; }
   inline const Real* operator[](int m) const { return store+upper*m; }
#endif
...
public:
   ...
   Real element(int, int) const;
#ifdef SETUP_C_SUBSCRIPTS
   inline Real* operator[](int m) { return store+lower*(m+1); }
   inline const Real* operator[](int m) const { return store+lower*(m+1); }
#endif
