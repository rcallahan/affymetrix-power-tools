...
#ifndef __BPMAPFILEDATATEST_H_
#define __BPMAPFILEDATATEST_H_

#include <cppunit/extensions/HelperMacros.h>

class CBPMAPFileDataTest : public CPPUNIT_NS::TestFixture  
{
	CPPUNIT_TEST_SUITE( CBPMAPFileDataTest );
	...
	CPPUNIT_TEST( testmethod_ReadV3File );
	...
	CPPUNIT_TEST( testmethod_FullName );
...
public:
	...
	void testmethod_FullName();
};


#endif // __BPMAPFILEDATATEST_H_
