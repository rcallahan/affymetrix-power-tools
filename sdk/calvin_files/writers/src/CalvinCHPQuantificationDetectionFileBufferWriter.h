...
public:
	 ...
	 * @param pvalue The pvalue for the entry.
	 */
	void WriteQuantificationDetectionEntry(int target, float quantification, float pvalue);
...
private:
	...
	std::vector< std::vector<std::pair<float, float> > > m_TargetQuantificationDetectionBuffers;
