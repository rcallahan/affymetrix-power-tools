...
#ifndef _CNAnalysisMethodLOH_H_
#define _CNAnalysisMethodLOH_H_
/**
 * @file CNAnalysisMethodLOH.h
 *
 * @brief This header contains the CNAnalysisMethodLOH class definition.
 */
 ...
 *
 */
class CNAnalysisMethodLOH : public CNAnalysisMethod
{
public:
    //LOH
...
public:
    CNAnalysisMethodLOH();
    virtual ~CNAnalysisMethodLOH() {}

    static std::string getType() {return "loh";}
    static std::string getDescription() {return "CopyNumber LOH";}
