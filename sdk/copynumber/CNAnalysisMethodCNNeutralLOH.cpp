...
/**
 * @file CNAnalysisMethodCNNeutralLOH.cpp
 *
 * @brief This file contains the CNAnalysisMethodCNNeutralLOH class members.
 */
 ...
 * @return SelfDoc
 */
SelfDoc CNAnalysisMethodCNNeutralLOH::explainSelf()
{
    CNAnalysisMethodCNNeutralLOH obj;
    SelfDoc doc;
 ...
 */
std::vector<SelfDoc::Opt> CNAnalysisMethodCNNeutralLOH::getDefaultDocOptions()
{
 ...
 */
SelfCreate* CNAnalysisMethodCNNeutralLOH::newObject(std::map<std::string,std::string>& params)
{
    SelfDoc doc = explainSelf();
    std::vector<SelfDoc::Opt> opts = getDefaultDocOptions();
    CNAnalysisMethodCNNeutralLOH* pMethod = new CNAnalysisMethodCNNeutralLOH();
 ...
 * @brief Constructor
 */
CNAnalysisMethodCNNeutralLOH::CNAnalysisMethodCNNeutralLOH()
{
 ...
 */
void CNAnalysisMethodCNNeutralLOH::run()
{
    Verbose::out(1, "CNAnalysisMethodCNNeutralLOH::run(...) start");
    isSetup();
    determineLocalProbeSets();
    m_vSegments.deleteAll();
    newSegments(getSegmentType(), getProbeSets());
    Verbose::out(1, "CNAnalysisMethodCNNeutralLOH::run(...) end");
}

void CNAnalysisMethodCNNeutralLOH::determineLocalProbeSets()
{
