...
bool CychpCheck::check(std::string &msg) {
    msg = "";
    ...
    for (int iIndex=0; iIndex<m_vFileNames.size(); iIndex++ )
    {
        ...
        std::string goldFile = m_GoldDirectory + "/" + m_vFileNames[iIndex] + "." + m_infix + ".cychp"; 
        std::string newFile = m_NewDirectory + "/" + m_vFileNames[iIndex] + "." + m_infix + ".cychp"; 
