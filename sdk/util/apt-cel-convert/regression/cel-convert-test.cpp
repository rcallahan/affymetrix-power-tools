...
const char *goldPath = "../../../regression-data/data/cel/HG-U133_Plus_2/";
...
void CelConvertTest::runTestHarness(const char *cels[], int size, const char *inFormat, const char *outFormat) {
  ...
  string testName = "doConvert_" + ToStr(inFormat) + "_to_" + ToStr(outFormat);
...
int main (int argc, char* argv[])
{
  try {
    FsTestDir testDir;
    testDir.setTestDir("util/cel-convert", true);
