...
//      printf("]\n");
    ...
    double confidence = (pxi_zj[biggest] > 0? pxi_zj[nextBiggest] / pxi_zj[biggest]: 1.0);
...
birdseed::v1::BasicGenotypeCaller::BasicGenotypeCaller(const IntensityMatrix &intensities,
                                         const Priors &priors,
...
double birdseed::v1::DummyGenotypeCaller::pvalues[MAX_NUM_CLUSTERS] = {0.0, 0.0, 0.0};

CallAndConfidence birdseed::v1::DummyGenotypeCaller::nextCall()
{
    return CallAndConfidence(CallAndConfidence::NOCALL, 1.0, pvalues, isDiploid);
}

birdseed::v1::ForcedClusterGenotypeCaller::ForcedClusterGenotypeCaller(const IntensityMatrix &intensities,
                                                         const Clusters &clusters,
                                                         double correctionFactor,
