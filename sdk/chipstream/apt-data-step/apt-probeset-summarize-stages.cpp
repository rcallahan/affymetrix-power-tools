...
int main(int argc,const char* argv[]) {
  ...
  try {
    ...
    ProbesetSummarizeStageEngine engine;
    ...
    /* Parse options. */
    engine.setUsage("apt-probeset-summarize-stages - A program for summarizing expression probe \n"
    ...
    engine.openStandardLog("apt-probeset-summarize-stages.log",logOut,log);
