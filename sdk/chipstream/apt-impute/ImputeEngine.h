...
#ifndef _IMPUTEENGINE_H_
#define _IMPUTEENGINE_H_
 ...
 */
class ImputeEngine : public BaseEngine {
    public:
			
		virtual std::string getEngineName() { return ImputeEngine::EngineName(); }
		static const std::string EngineName() { return "ImputeEngine"; }
		...
		*/
		...
		public:
			...
			Reg() : EngineReg(ImputeEngine::EngineName())
			{
			}
			 ...
			 * @return The object.
			 */
			BaseEngine *MakeObject() { return new ImputeEngine; }
		};
		 ...
		 */
		static ImputeEngine * FromBase(BaseEngine *engine);
