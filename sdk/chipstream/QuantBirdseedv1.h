...
#ifndef _QUANTBIRDSEEDV1_H_
#define _QUANTBIRDSEEDV1_H_
...
#define QUANTBIRDSEEDV1 "birdseed-v1"

class QuantBirdseedv1 : public QuantBirdseed {
  ...
  public:
    ...
    QuantBirdseedv1(double confidenceThreshold, double correctionFactor): QuantBirdseed(confidenceThreshold, correctionFactor)
    {
        setupSelfDoc(*this);
    ...
    static void setupSelfDoc(SelfDoc &doc) {
        doc.setDocName(QUANTBIRDSEEDV1);
        doc.setDocDescription("Do genotyping calls using the Birdseed v1 algorithm.");
     ...
     */  
    std::string getType() {
        return std::string(QUANTBIRDSEEDV1);
    }
