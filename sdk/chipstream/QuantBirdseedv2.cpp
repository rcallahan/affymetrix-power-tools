...
SelfDoc QuantBirdseedv2::explainSelf() { 
    SelfDoc doc;
    setupSelfDoc(doc);
    return doc;
}

std::vector<SelfDoc::Opt> QuantBirdseedv2::getDefaultDocOptions() { 
...
SelfCreate *QuantBirdseedv2::newObject(std::map<std::string,std::string> &param) {
    ...
    QuantBirdseedv2 *obj = new QuantBirdseedv2(confThreshold, correctionFactor);
 ...
 */
void QuantBirdseedv2::computeEstimate()
{
...
void QuantBirdseedv2::setPriorFile(const std::string& priorsPath, const string &chipType, 
