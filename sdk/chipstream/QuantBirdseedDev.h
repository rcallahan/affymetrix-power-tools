...
/*  
 * FILE QuantBirdseedDev.h
 */

#ifndef _QUANTBIRDSEEDDEV_H_
#define _QUANTBIRDSEEDDEV_H_
...
#define QUANTBIRDSEEDDEV "birdseed-dev"

class QuantBirdseedDev : public QuantBirdseed {
  ...
  public:
    ...
    QuantBirdseedDev(double confidenceThreshold, double correctionFactor): QuantBirdseed(confidenceThreshold, correctionFactor)
    {
        setupSelfDoc(*this);
    ...
    static void setupSelfDoc(SelfDoc &doc) {
        doc.setDocName(QUANTBIRDSEEDDEV);
        doc.setDocDescription("Do genotyping calls using the Birdseed Developmental algorithm.");
     ...
     */  
    std::string getType() {
        return std::string(QUANTBIRDSEEDDEV);
    }
...
#endif /* _QUANTBIRDSEEDDEV_H_ */

/******************************************************************/
/**************************[END OF QuantBirdseedDev.h]****************/
/******************************************************************/
/* Emacs configuration
 * Local Variables:
 * mode: C++
